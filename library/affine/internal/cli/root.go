...
Run 'affine-pp-cli doctor' to verify auth and connectivity.`,
	...
	rootCmd.SetVersionTemplate("affine-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'affine-pp-cli profile list')")
	...
	rootCmd.AddCommand(newBlobsCmd(flags))
	rootCmd.AddCommand(newCommentsCmd(flags))
	rootCmd.AddCommand(newCopilotsCmd(flags))
